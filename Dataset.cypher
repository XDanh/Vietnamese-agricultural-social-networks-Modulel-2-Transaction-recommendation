//CREATE PRODUCT
    ...
    //CREATE USER
    CREATE (Keanu:User {Username:'Keanu Reeves',gender:" ",phonenumber:" ", address:" ",birthday:1964,email:'Keanu@gmail.com',password:'lv123'})
    CREATE (Carrie:User {Username:'Carrie-Anne Moss',gender:" ",phonenumber:" ", address:" ",birthday:1967,email:'Carrie@gmail.com',password:'lv123'})
    CREATE (Laurence:User {Username:'Laurence Fishburne',gender:" ",phonenumber:" ", address:" ",birthday:1961,email:'Laurence@gmail.com',password:'lv123'})
    CREATE (Hugo:User {Username:'Hugo Weaving',address:" ",gender:" ",phonenumber:" ", birthday:1960,email:'Hugo@gmail.com',password:'lv123'})
    CREATE (LillyW:User {Username:'Lilly Wachowski',address:" ",gender:" ",phonenumber:" ", birthday:1967,email:'LillyW@gmail.com',password:'lv123'})
    CREATE (LanaW:User {Username:'Lana Wachowski',address:" ",gender:" ",phonenumber:" ", birthday:1965,email:'LanaW@gmail.com',password:'lv123'})
    CREATE (JoelS:User {Username:'Joel Silver',address:" ",gender:" ",phonenumber:" ", birthday:1952,email:'JoelS@gmail.com',password:'lv123'})
    CREATE (StefanArndt:User {Username:"Stefan Arndt",gender:" ",phonenumber:" ",address:" ", birthday:1961,email:'StefanArndt@gmail.com',password:'lv123'})
    CREATE (Howard:User {Username:'Howard Deutch',gender:" ",phonenumber:" ",address:" ", birthday:1950,email:'Howard@gmail.com',password:'password:'lv123'})
    CREATE (ClintE:User {Username:'Clint Eastwood',gender:" ",phonenumber:" ",address:" ", birthday:1930,email:'ClintE@gmail.com',password:password:'lv123'})
    CREATE (MikeN:User {Username:'Mike Nichols',gender:" ",phonenumber:" ",address:" ", birthday:1931,email:'MikeN@gmail.com',password:'lv123'})
    CREATE (RonH:User {Username:'Ron Howard',gender:" ",phonenumber:" ",address:" ", birthday:1954,email:'RonH@gmail.com',password:'lv123'})
    //Category
